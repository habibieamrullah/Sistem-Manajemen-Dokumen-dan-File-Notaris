                        ...
                        <tbody>
                            ...
                            <?php foreach ($lap_lain_saya as $lls) : ?>
                                <tr>
                                    ...
                                    <td><?php echo $lls['nomor_akta']; ?></td>
                                    <td><a target="_blank" href="<?php echo base_url() ?>lihat/?c=4&id=<?php echo $lls['unid'] ?>&barcode=1">Lihat</a></td>
                                    <td><a target="_blank" href="<?php echo base_url() ?>lihat/?c=4&id=<?php echo $lls['unid'] ?>">Klik</a></td>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h3 class="modal-title" style="font-weight:800;">File Lainya</h3>
            </div>
