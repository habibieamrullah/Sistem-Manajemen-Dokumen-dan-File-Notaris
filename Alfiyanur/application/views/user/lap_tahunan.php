...
<div class="content-wrapper">
    ...
    <section class="content-header">
        <h3>File Firma Persekutuan Perdata</h3>
    </section>
    <!-- Main content -->
                        ...
                        <tbody>
                            ...
                            <?php foreach ($lap_tahunan_saya as $lts) : ?>
                                <tr>
                                    ...
                                    <td><?php echo $lts['nomor_akta']; ?></td>
                                    <td><a target="_blank" href="<?php echo base_url() ?>lihat/?c=5&id=<?php echo $lts['unid'] ?>&barcode=1">Lihat</a></td>
                                    <td><a target="_blank" href="<?php echo base_url() ?>lihat/?c=5&id=<?php echo $lts['unid'] ?>">Klik</a></td>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h3 class="modal-title" style="font-weight:800;">File Firma Persekutuan Perdata</h3>
            </div>
