                        ...
                        <tbody>
                            ...
                            <?php foreach ($lap_bulanan_saya as $lbs) : ?>
                                <tr>
                                    ...
                                    <td><?php echo $lbs['nomor_akta']; ?></td>
                                    <td><a target="_blank" href="<?php echo base_url() ?>lihat/?c=2&id=<?php echo $lbs['unid'] ?>&barcode=1">Lihat</a></td>
                                    <td><a target="_blank" href="<?php echo base_url() ?>lihat/?c=2&id=<?php echo $lbs['unid'] ?>">Klik</a></td>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h3 class="modal-title" style="font-weight:800;">File PT</h3>
            </div>
